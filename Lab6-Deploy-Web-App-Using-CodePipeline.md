...
### Step 3: Create an IAM Role for the Web Server
...
### Step 4: Install the CodeDeploy Agent in the EC2 Instance
...
### Step 5: Create an IAM Role for the CodeDeploy Service
